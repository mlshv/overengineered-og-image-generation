...
export async function generate({
  ...
  return new ImageResponse(
    (
      <div
        tw="flex items-center justify-center bg-white w-full h-full p-8"
      >
        <div
        ...
        >
          <div tw="flex items-center justify-center">
            <div tw="flex rounded-full overflow-hidden w-156 h-156">
              <img src={user.avatar} alt={user.name} tw="h-full" />
            </div>
          </div>
          <div tw="flex flex-col items-center" style={{ gap: 64 }}>
            <div tw="flex flex-col items-center text-center font-bold text-8xl">
              <div>{user.name}</div>
              <div>invites you to join</div>
            </div>
            <div tw="text-5xl text-gray-500 text-center">
